  ...
  return (
    ...
    <div className=' wrapper container-fluid d-flex align-items-center justify-content-center position-relative  w-100' style={{minwidth:'50%' , height:'80vh'}}>
      ...
      <div className='col-md-4 col-sm-12  d-flex p-4  '>
              ...
              <img src="/CoverImage/loginimg.png" alt='' className='img-fluid h-100'
              style={{width:'90%'}} />
              </div>
              </div>
            ...
            <div className=" col-md-7  d-flex flex-column align-items-stretch mb-3 p-5 " >
                ...
                <p>Don't have an Account  <Link to="/CreateAccount" 
                className='link-primary text-decoration-underline mb-5'> Create a Account</Link> 
              ...
              <div className='form-group '>
                <label className=' display-inline fw-bold mb-3' htmlFor='password'>Password
